...
class PhoneAppContainer(private val context: Context) {
    ...
    val flavor: PhoneHarnessFlavor = createPhoneHarnessFlavor(
        context = context,
    ...
    init {
        background.execute {
            ...
            PhoneHarnessRuntime.hooks?.onRecoveryComplete?.invoke()
        }
    }
...
object PhoneHarnessRuntime {
    var container: PhoneAppContainer? = null
    var hooks: PhoneRuntimeHooks? = null
}

class PhoneRuntimeHooks {
