...
fun createGlassesHarnessFlavor(
    ...
    return GlassesHarnessFlavor(
        controller = HarnessController(
            ...
            pairProbe = RealPairProbe(stores.credentialStore, stores.identityStore, stores.endpointStore, publisher = stores.publisher),
            relayPairProbe = RealRelayPairProbe(stores.credentialStore, stores.identityStore, endpointStore = stores.endpointStore, publisher = stores.publisher),
