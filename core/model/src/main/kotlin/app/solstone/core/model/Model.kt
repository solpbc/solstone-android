...
enum class SourceState { OFF, READY_TO_SET_UP, SETTING_UP, ON, PAUSED, NEEDS_ATTENTION }
enum class SilencedFact { NOT_SILENCED, SILENCED, UNKNOWN }
enum class ReasonCode { NONE, PERMISSION_REVOKED, SERVICE_KILLED, REBOOTED, UNPAIRED, STORAGE_FULL, PROVIDER_SILENT, AUTH_REVOKED, TRANSPORT_UNAVAILABLE, FOREGROUND_START_NOT_ALLOWED, FOREGROUND_TYPE_NOT_HELD, DESIRED_OFF, PERSISTENCE_FAILED, AUDIO_CHOICE_NOT_SAVED, AUDIO_CHOICE_NOT_SAVED_STOP_NOT_DURABLE, AUDIO_CHOICE_SAVED_STOP_NOT_DURABLE, INTAKE_STOPPED_UNEXPECTEDLY }
