...
enum class ReasonCode { NONE, PERMISSION_REVOKED, SERVICE_KILLED, REBOOTED, UNPAIRED, STORAGE_FULL, PROVIDER_SILENT, AUTH_REVOKED, EXEMPTION_UNVERIFIED, TRANSPORT_UNAVAILABLE, FOREGROUND_START_NOT_ALLOWED, DESIRED_OFF }
