...
enum class ReasonCode { NONE, PERMISSION_REVOKED, SERVICE_KILLED, REBOOTED, UNPAIRED, STORAGE_FULL, PROVIDER_SILENT, AUTH_REVOKED, TRANSPORT_UNAVAILABLE, FOREGROUND_START_NOT_ALLOWED, FOREGROUND_TYPE_NOT_HELD, DESIRED_OFF }
