...
object SolstoneColorSchemes {
    ...
    val darkStandard: ColorScheme = darkColorScheme(
        ...
        outline = SolstoneColors.solOrangeAccessible,
        outlineVariant = SolstoneColors.surfaceDarkLift,
        scrim = SolstoneColors.surfaceBlack,
        surfaceBright = SolstoneColors.surfaceDarkLift,
        surfaceDim = SolstoneColors.surfaceBlack,
        surfaceContainer = SolstoneColors.surfaceDark,
        surfaceContainerHigh = SolstoneColors.surfaceDarkLift,
        surfaceContainerHighest = SolstoneColors.surfaceDarkLift,
        surfaceContainerLow = SolstoneColors.surfaceDark,
