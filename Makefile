...
ci:
		$(GRADLE) check :core:model:test :core:sources:test :core:segment:test :core:spool:test :core:queue:test :core:diagnostics:test :core:crypto:test :core:pl:test :core:identity:test :core:observer:test :testing:test :platform:camera-still:test :platform:work:test :platform:persistence-room:assembleDebug :platform:pl-transport-conscrypt:assembleDebug :platform:identity-file:assembleDebug :platform:work:assembleDebug :platform:audio:assembleDebug :platform:location:assembleDebug :platform:camera-legacy:assembleDebug :platform:camera2:assembleDebug :platform:fgs:assembleDebug :platform:power:assembleDebug :apps:watch:checkRealDebugMicrophoneManifest :apps:phone:checkRealDebugMicrophoneManifest :apps:watch:assembleMockDebug :apps:watch:assembleRealDebug :apps:phone:assembleMockDebug :apps:phone:assembleRealDebug :apps:validation-rogbid:assembleDebug
